export default {
  ...
  "signin.input.email-or-username": "用户名",
  "signin.input.email-or-username.placeholder": "请输入员工号",
  "signin.input.password": "密码",
  "signin.input.password.placeholder": "请输入AD账号密码",
  ...
  "signIn.oauth.nwcd": "通过 NWCD SSO 登录",
  // END /auth/signin
  // /auth/signup
  "signup.title": "创建账户",
  ...
  "admin.config.oauth.nwcd-enabled": "激活 NWCD SSO 登录",
  ...
  "error.param.provider_nwcd": "无效的 NWCD SSO 配置",
  // Common translations
